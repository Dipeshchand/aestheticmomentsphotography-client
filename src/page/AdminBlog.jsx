...
// http://localhost:5000
  ...
  const fetchBlogs = async () => {
    try {
      const res = await axios.get("https://aestheticmomentsphotography-client.onrender.com/api/blogs");
      setBlogs(res.data);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post("https://aestheticmomentsphotography-client.onrender.com/api/blogs", formData, {
        headers: {
  ...
  const deleteBlog = async (id) => {
    ...
    try {
      await axios.delete(`https://aestheticmomentsphotography-client.onrender.com/api/blogs/${id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
